...
namespace OneStar
{
	class AdditionalNestIdTable
	{
		...
		public static readonly Dictionary<int, Data> c_DLC1Table = new Dictionary<int, Data>
		{
			...
			// 鍋底砂漠 TODO
			{ 137, new Data( "8769170721942624824", "14477537978666912344", 0, 0, 0)},
			{ 138, new Data( "6589539950519384197", "3561902408726248099", 0, 0, 0)},
			{ 139, new Data( "6984833918694526192", "5701096561044283325", 0, 0, 0)}, // キョダイサダイジャ
			// ハニカームの海 TODO
			{ 140, new Data( "7956530560371257544", "2024757571205803752", 0, 0, 0)},
			{ 141, new Data( "14284833672245134656", "7704513452465554544", 0, 0, 0)},
			{ 142, new Data( "4780546875801935381", "18345022727441378877", 0, 0, 0)},
